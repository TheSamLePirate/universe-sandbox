            ...
            <div className="space-y-2">
                <div className="flex justify-between items-center text-[10px] text-slate-500 font-bold uppercase">
                    ...
                    {recordedManeuvers.length > 0 && (
                        <button onClick={loadRecordedToFlightPlan} className="text-indigo-400 flex gap-1 items-center">
                        ...
                        if (maneuver.status === 'active') {
                            if (maneuver.type === 'wait' || maneuver.type === 'burn') {
                                ...
                                if (parentBody) {
                                    ...
                                    progressBar = (
                                        <div className="w-full bg-slate-700 h-1.5 rounded-full mt-1 overflow-hidden">
                                            <div className="h-full bg-yellow-500 transition-all duration-100" style={{ width: `${progressPercent.toFixed(0)}%` }} />
                                        </div>
                                    );
                                }
