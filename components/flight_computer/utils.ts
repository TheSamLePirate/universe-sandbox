...
import { Activity, ArrowRightLeft, Calculator, Crosshair, Eye, Info, MapPin, MousePointer2, Move, Play, Radar, Radio, Rocket, Ruler, Speaker, Terminal, Zap, Keyboard } from 'lucide-react';
